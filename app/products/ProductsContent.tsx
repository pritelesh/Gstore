...
export default function ProductsContent({
  ...
  const syncSearchParams = useCallback(
    (search: string, categories: string[], minPrice: string, maxPrice: string, sort: string, page: number) => {
  ...
  useEffect(() => {
    syncSearchParams(search, selectedCategories, minPrice, maxPrice, sort, page);
  }, [search, selectedCategories, minPrice, maxPrice, sort, page, syncSearchParams]);
  ...
  return (
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4">
        ...
        {fetchError ? (
          <div className="neu-flat p-10 text-center max-w-md mx-auto">
